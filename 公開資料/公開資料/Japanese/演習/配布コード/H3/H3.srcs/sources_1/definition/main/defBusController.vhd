...
package defBCT is
  ...
  constant kCurrentVersion      : std_logic_vector(31 downto 0):= x"aaaa1111";
  ...
  constant kMidC6C      : std_logic_vector(kWidthModuleID-1 downto 0) := "0001";
  constant kMidMIG      : std_logic_vector(kWidthModuleID-1 downto 0) := "0010";
  ...
  constant kC6C   : Leaf := (ID => 1);
  constant kMIG   : Leaf := (ID => 2);
  constant kSDS   : Leaf := (ID => 3);
  constant kFMP   : Leaf := (ID => 4);  
  constant kDummy : Leaf := (ID => -1);

--  constant AddressBook : Binder(kNumModules-1 downto 0) :=
--    ( 0=>kLED, 1=>kC6C, 2=>kMIG, 3=>kSDS, 4=>kFMP, others=>kDummy );
