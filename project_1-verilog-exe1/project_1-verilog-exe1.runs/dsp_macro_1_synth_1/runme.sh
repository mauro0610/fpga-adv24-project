...
HD_PWD='C:/Users/OhmoriG_Rogue/Downloads/fpga-advanced-2024/project_1-verilog-exe1/project_1-verilog-exe1.runs/dsp_macro_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_macro_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_macro_1.tcl
